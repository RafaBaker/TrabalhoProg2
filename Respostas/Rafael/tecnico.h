...
/**
 * Estrutura de um Tecnico, contendo um ator (pessoa) e as informações exclusivas do tipo Tecnico
 */
...
/**
 * @brief Retorna o número de bytes da struct Tecnico
 * 
 * @return O número de bytes de uma struct Tecnico
 */
int numBytesTecnico();
 ...
 * 
 * @param t O técnico que receberá o ticket
